...
DATASET_DIR = '/Users/svirinstepan/PycharmProjects/AnomalyBert/dataset/processed'
LOG_DIR = 'logs/'
DATA_PROPERTY_DIR = 'data/'


DATASET_LIST = ['SMAP', 'MSL', 'SMD', 'SWaT', 'WADI', 'LIMAN', 'SIGN', 'BNLD', 'BAD_BNLD', 'F3G', 'LABELED', 'SEGMENTED']
